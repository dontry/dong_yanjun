...
public class Account {
    ...
    public Account(long accountId, String username, TypeOfAccount typeOfAccount, boolean locked, double balance) {
    ...
    public static Account convertToAccount(HashMap<String, Object> map) {
        ...
        return new Account(account_id, username, type, lockStatus, balance);
    }
}
