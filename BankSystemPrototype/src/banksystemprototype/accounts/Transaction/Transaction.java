package banksystemprototype.accounts.Transaction;
...
public class Transaction {
    ...
    public Transaction(long mTransNum, TypeOfTransaction mTransType, Date mTransDate, double mAmount,  long mToAccountId, long mFromAccountId) {
